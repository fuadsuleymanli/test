...
<div class="page-content-wrap">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="widget widget-default widget-item-icon" onclick="location.href='{{ route('admin.user.activeusers') }}';">
                            <div class="widget-item-left">
                                <span class="fas fa-users" style="font-size:50px"></span>
                            </div>
                            <div class="widget-data">
                                <div class="widget-int num-count">{{ count($activeUsers) }}</div>
                      ...
                      <div class="col-md-3">
                          ...
                          <div class="widget widget-default widget-item-icon" onclick="location.href='{{ route('admin.user.newusers') }}';">
                              <div class="widget-item-left">
                                  <span class="fas fa-user-clock" style="font-size:50px"></span>
                              </div>
                              <div class="widget-data">
                                  <div class="widget-int num-count">{{ count($newUsers) }}</div>
                                  <div class="widget-title">New user</div>
                                  <div class="widget-subtitle">On your website</div>
                              </div>
                              <div class="widget-controls">
                                  <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>
